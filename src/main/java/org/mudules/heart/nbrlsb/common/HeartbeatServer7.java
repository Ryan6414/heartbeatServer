...
@Data
@Order(value = 7)
public class HeartbeatServer7 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port7}")
    Integer port;
