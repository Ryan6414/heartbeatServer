...
@Data
@Order(value = 2)
public class HeartbeatServer2 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port2}")
    Integer port;
