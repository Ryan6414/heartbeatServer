...
@Data
@Order(value = 3)
public class HeartbeatServer3 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port3}")
    Integer port;
