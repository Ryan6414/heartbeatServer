...
@Data
@Order(value = 8)
public class HeartbeatServer8 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port8}")
    Integer port;
