...
@Data
@Order(value = 4)
public class HeartbeatServer4 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port4}")
    Integer port;
