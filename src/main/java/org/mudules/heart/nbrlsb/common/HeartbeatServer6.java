...
@Data
@Order(value = 6)
public class HeartbeatServer6 {

    @Autowired
    private SnStatusServer statusServer;

    @Value("${listener.port6}")
    Integer port;
